    ...
    <Container>
      ...
      >
        ...
        <Tab eventKey="experience" title="Experience">
          <h6>Indeed</h6>
          <p>
            I began at Indeed in 2021 as a QA Automation Engineer. 
            ...
            As a part of that transition, I have completed Thinkful (now Chegg Skills) certifications in Front End Development (React course), Back End Development (Express and PostGres course), and Data Structures and Algorithms, earning a Chegg Skills and Indeed co-branded Software Engineering Certificate.
          ...
          <p>
            ...
            My computer science and programming background led to me building the test automation suite for the business unit I was in entirely from the ground up. 
            ...
            I was also responsible for on-call shifts, debugging production issues with the team, and doing our bi-weekly production deployments.
          </p>
          ...
          <p>
            ...
            My internship was essentially broken into three parts: a survey of machine learning techniques for clustering data, designing an algorithm to perform k-medoids clustering through multiparty computation, and implementing that algorithm in a C++17 internally built framework for multiparty computation. 
            I presented a work-in-progress talk on my project halfway through the internship, studied and presented a talk on zero knowledge proofs constructed from multiparty computation (Zero-Knowledge from Secure Multiparty Computation, Ishai et al, SICOMP 2007), and wrote and presented a full length research paper on my project.
          </p>
        </Tab>
          ...
          >
            <Tab eventKey="professional" title="Professional">
              ...
              <p>
                ...
                I get a deep sense of satisfaction from taking an idea from architecture to implementation in order to assure that data winds up in the right place and is used responsibly and securely to get the desired outcome. 
              ...
              <p>
                ...
                Continuous Integration and Continuous Development offers the ability to move quickly as engineers, both to deliver our code and to fix issues in a timely fashion. 
              ...
              <p>
                ...
                By automating tests and integrating them into deploy pipelines, we are able to ensure the correct functionality of core workflows in our systems, which prevents major outages in our applications more often than not. 
                My personal testing philosophy is as follows: minimum 85% coverage on unit tests, integration tests for every 'happy path' call to each API endpoint, end-to-end API tests for the core functionalities of our whole system, Selenium-based testing for the core happy path functions of our web applications, and manual testing for any new frontend features or critical business concerns.
              </p>
              <h6>DevOps</h6>
              <p>
                ...
                The infrastructure work is a logical extension of my career experience in QA Automation, as it is a broader scope area of work that still aims to ensure that products go out the door working in proper order.
              ...
              <p>
                ...
                I am hoping to find the time to learn more about modern encryption algorithms like AES and TLS, as well as to understand post-quantum cryptography.
              </p>
            </Tab>
